			...
			oODataModel.read("/MyWorkListCnfrmSet", {
				...
				success: function (oData) {
					...
					if (oData.results && oData.results.length > 0) {
						...
						var bIsEditable = (sStatusUpper === "" || sStatusUpper === "DRAFT" || sStatusUpper === "REJECTED");
						oView.getModel("stateModel").setProperty("/isEditable", bIsEditable);
			...
			oODataModel.read("/MyWorkListCnfrmSet", {
				...
				success: function (oData) {
					...
					if (oData.results && oData.results.length > 0) {
						...
						var sStatusUpper = (oSrvData.Status || "").toUpperCase();
						var bIsEditable = (sStatusUpper === "" || sStatusUpper === "DRAFT" || sStatusUpper === "REJECTED");
						oStateModel.setProperty("/isEditable", bIsEditable);
		...
		editAction: function () {
			...
			oModel.create("/MyWorkListCnfrmSet", oEntry, {
				success: function (oData, response) {
					...
					that.enableFooter();
					oView.getModel("stateModel").setProperty("/isEditable", true);
